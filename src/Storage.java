/**
 * The Storage class provides functionality for storing data to a file and displaying records from the file.
 * It encapsulates the private variables file, fWrite, fRead, and scan, and provides public methods to interact with them.
 ...
 * The class can be easily reused in other parts of the program or in other projects due to its generic functionality.
 */
import java.io.*;
import java.util.*;
...
// ENCAPSULATED WITHIN THE CLASS, AND PUBLIC METHODS ARE PROVIDED TO INTERACT
// WITH THEM.
// 2. POLYMORPHISM: METHOD OVERLOADING IS USED IN THE CONSTRUCTORS TO PROVIDE
// MULTIPLE WAYS OF INSTANTIATING THE CLASS.
// 3. ABSTRACTION: THE CLASS PROVIDES SIMPLE INTERFACES (METHODS) FOR STORING
// DATA TO A FILE AND DISPLAYING RECORDS, HIDING THE COMPLEXITY OF THE
// IMPLEMENTATION.
// 4. REUSABILITY: THE CLASS CAN BE EASILY REUSED IN OTHER PARTS OF THE PROGRAM
